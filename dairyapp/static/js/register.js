...
function usernameValidation(inputTxt) {
    ...
    if (inputTxt.value != '') {
        if (inputTxt.value.length >= 6 && inputTxt.value.length <= 20) {
            if (inputTxt.value.match(regx)) {
                textField.textContent = '';
                textField.style.color = "";
            } else {
                textField.textContent = '**Only letters and numbers are allowed"';
                textField.style.color = "red";
            }
        } else {
            textField.textContent = '**Your username must be between 6 and 20 characters';
            textField.style.color = "red";
        }
    } else {
        textField.textContent = '**Please enter your username';
        textField.style.color = "red";
    }
}
